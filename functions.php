...
require_once get_template_directory() . '/includes/header-edits.php';
require_once get_template_directory() . '/includes/footer-hooks.php';
...
require_once get_template_directory() . '/includes/case-study-options.php';